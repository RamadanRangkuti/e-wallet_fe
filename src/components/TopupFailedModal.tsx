...
export function TopupFailedModal({ onTryAgain, onBackTo }: TransferSuccessModalProps) {
        ...
        <div className="flex flex-col font-montserrat">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex flex-col items-center">
              <div className="font-semibold">Oops Topup <span className="text-red-600">Failed</span></div>
              <div className="text-sm text-gray-400 mt-2">Sorry There is an issue for your topup, try again later!</div>
            </div>
