            ...
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              ...
              <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
                <div className="flex flex-col self-stretch my-auto max-md:mt-10 max-md:max-w-full">
                  <p className="text-base text-white max-md:max-w-full">Simplify Your Life with Secure and Convenient Mobile Payments</p>
                  ...
                  <div className="flex flex-col mt-6 text-white max-md:max-w-full">
                    ...
                    <p className="mt-3 text-base max-md:max-w-full">Around the world, we already have over 4.6 happy user</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="flex gap-5 max-md:flex-wrap">
          ...
          <article className="flex gap-2.5 pr-2.5">
            ...
            <div className="flex flex-col">
              ...
              <p className="mt-2 text-base text-gray-600">Zwallet is 100% totally free to use it’s now available on Google Play Store and App Store.</p>
            </div>
          </article>
        </div>
      </section>
          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            ...
            <article className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col items-start self-stretch my-auto text-lg font-bold text-green-700 max-md:mt-10 max-md:max-w-full">
                ...
                <p className="self-stretch mt-6 text-base text-stone-900 max-md:max-w-full">We have some great features from the application and it’s totally free to use by all users around the world.</p>
          ...
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            ...
            <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col self-stretch my-auto font-medium max-md:mt-10 max-md:max-w-full">
                ...
                <p className="mt-6 text-base leading-6 text-slate-900 max-md:max-w-full">Ready to experience the future of payments? Download e-wallet now and enjoy a world of convenience at your fingertips.</p>
