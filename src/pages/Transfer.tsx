...
function TransferPage() {
  ...
  return (
    <main className="font-montserrat max-h-screen w-full md:p-8">
      <div className="flex-col w-full">
        <div className="flex md:mb-7">
          <div className="flex flex-col w-full gap-5">
            <div className="flex items-center bg-primary w-full text-white text-xs md:text-base md:font-bold px-7 md:px-0 py-2 md:bg-white md:text-black gap-2">
            ...
            <div className="hidden md:flex w-full md:w-fit items-center gap-4">
              {steps.map((step, index) => (
                <div key={step.number} className="flex items-center">
                  <div className={`flex items-center justify-center w-5 h-5 ${currentStep === step.number ? 'bg-blue-600' : 'bg-gray-700'} text-sm text-white rounded-full ml-2 mr-1`}>
                    {step.number}
                  </div>
        ...
        {currentStep === 2 && selectedPersonId && (
