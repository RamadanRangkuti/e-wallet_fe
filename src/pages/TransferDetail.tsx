  ...
  return (
    <div className="max-h-screen w-full pl-8 py-8">
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col border mr-8 px-7 py-7 mb-10 max-h-full gap-6 overflow-y-auto">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="text-sm text-gray-500 mb-4">Type the amount you want to transfer and the press continue to the next steps.</div>
          ...
          <div className="flex flex-col">
            ...
            <textarea
              name="notes"
              className="border rounded-md focus:outline-gray-400 font-semibold p-4 h-40 resize-none"
              placeholder="Enter Some Notes"
              autoComplete="off"
              style={{ textAlign: 'start', paddingTop: '0.5rem' }}
            />
          </div>
          <button className="bg-blue-600 h-12 rounded-lg text-white font-thin tracking-wider">Submit & Transfer</button>
        </div>
      </div>
    </div>
  );
