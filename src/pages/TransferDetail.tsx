      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col border mr-8 px-7 py-7 mb-10 max-h-[400px] gap-6 overflow-y-auto">
          ...
          <div className="flex flex-col">
            ...
            <textarea
              name="notes"
              className="border rounded-md focus:outline-gray-400 font-semibold p-4 h-32 resize-none"
          ...
          <button
            className="bg-blue-600 min-h-10 rounded-lg text-white font-thin tracking-wider"
