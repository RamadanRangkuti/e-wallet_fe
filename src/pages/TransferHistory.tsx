...
function TransferHistory() {
  return (
    <>
      ...
      <div className="bg-white w-full md:p-4">
        <div className="w-full max-md:max-w-full ">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            <div className="flex flex-col ml-5 w-4/5 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col  max-md:max-w-full md:p-4 w-full">
                ...
                <div className="flex flex-col px-8 pt-6 pb-11 md:mt-9 md:border md:border-gray-200 md:border-solid max-md:px-5 max-md:max-w-full p-8 w-full gap-4">
